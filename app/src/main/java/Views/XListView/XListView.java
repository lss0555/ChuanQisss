...
public class XListView extends ListView implements OnScrollListener {
	...
	private void initWithContext(Context context) {
		...
		mTvFooterHint = (TextView) mFooterView.findViewById(R.id.xlistview_footer_hint_textview);
	...
	public void setFooterState(String text) {
		mTvFooterHint.setText(text);
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (getFirstVisiblePosition() == 0
				...
				Log.i("XListView中头部显示的高度",""+deltaY);
				...
				Log.i("XListView中的Deltay<0",""+mFooterView.getBottomMargin());
			}
			break;
		default:
			mLastY = -1; // reset
